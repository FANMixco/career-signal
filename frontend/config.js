...
window.CAREER_SIGNAL_CONFIG = {
  ...
  feedback: {
    ...
    missingCv: "Add a CV PDF, LinkedIn PDF export, or paste complete CV text before running the precheck.",
    invalidPdf: "Only PDF uploads are supported. Choose a CV PDF, LinkedIn PDF export, or paste CV text instead.",
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "Upload a CV PDF, LinkedIn PDF export, or paste your CV text.",
